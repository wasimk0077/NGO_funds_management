...
import 'package:beta_app/ui/Trans_history_filter1.dart';
import 'package:beta_app/ui/Trans_history_filter2.dart';
import 'package:beta_app/ui/Trans_history_filter3.dart';
import 'package:beta_app/ui/Trans_history_filter4.dart';
import 'package:beta_app/ui/Trans_history_filter5.dart';
import 'package:beta_app/ui/Trans_history_type1.dart';
...
import 'Trans_history_type2.dart';
import 'Trans_history_type3.dart';
import 'Trans_history_type4.dart';
...
class Transaction_History_ extends StatefulWidget {
  Transaction_History_({super.key,required this.UserAdress });
  final String UserAdress;

  @override
  State<Transaction_History_> createState() => Transaction_History_State();
}

class Transaction_History_State extends State<Transaction_History_> {
  ...
  await FirebaseFirestore.instance.collection("Transactions").get().then((value) {
    for(var i in value.docs) {
     ...
     if(widget.UserAdress==i["NGO_Transactions"]["User_Address"])
     {
      ...
      temp_class.details["TransactionHash"]=i["NGO_Transactions"]["Transaction_Hash"];
      ...
      builder: (context, setState) {
              ...
              height: MediaQuery.of(context).size.height / 28,
                ...
                child: TextButton(
                  onPressed: ()  {
                     Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) => Transaction_History_Filter1(UserAdress: widget.UserAdress)
));
      //               filter1=false;
      //              filter1=true;
      //              filter2=false;
        ...
        return Colors.white; // Defer to the widget's default.
              ...
              height: MediaQuery.of(context).size.height / 28,
                ...
                child: TextButton(
                  onPressed: ()  {
                    Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) => Transaction_History_Filter2(UserAdress: widget.UserAdress)
));
      //               filter1=false;
      //              filter2=true;
      //              filter3=false;
        ...
        return Colors.white; // Defer to the widget's default.
              ...
              height: MediaQuery.of(context).size.height / 28,
                ...
                child: TextButton(
                  onPressed: () {
                     Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) => Transaction_History_Filter3(UserAdress: widget.UserAdress)
));
      //               filter1=false;
      //              filter2=false;
      //              filter3=true;
        ...
        return Colors.white; // Defer to the widget's default.
              ...
              height: MediaQuery.of(context).size.height / 28,
                ...
                child: TextButton(
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) => Transaction_History_Filter4(UserAdress: widget.UserAdress)
));
      //               filter1=false;
      //              filter2=false;
      //              filter3=false;
        ...
        return Colors.white; // Defer to the widget's default.
              ...
              height: MediaQuery.of(context).size.height / 28,
                ...
                child: TextButton(
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) => Transaction_History_Filter5(UserAdress: widget.UserAdress)
));
                  //   filter1=false;
                  //  filter2=false;
                  //  filter3=false;
        ...
        return Colors.white; // Defer to the widget's default.
              ...
              height: MediaQuery.of(context).size.height / 28,
                ...
                child: TextButton(
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) => Transaction_History_Type1(UserAdress: widget.UserAdress)
));
      //               filter1=false;
      //              filter2=false;
      //              filter3=false;
        ...
        return Colors.white; // Defer to the widget's default.
              ...
              height: MediaQuery.of(context).size.height / 28,
                ...
                child: TextButton(
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) => Transaction_History_Type2(UserAdress: widget.UserAdress)
));
                  //   filter1=false;
                  //  filter2=false;
                  //  filter3=false;
        ...
        return Colors.white; // Defer to the widget's default.
              ...
              height: MediaQuery.of(context).size.height / 28,
                ...
                child: TextButton(
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) => Transaction_History_Type3(UserAdress: widget.UserAdress)
));
      //               filter1=false;
      //              filter2=false;
      //              filter3=false;
  ...
  overlayColor: MaterialStateProperty.resolveWith<Color?>(
        ...
        return Colors.white; // Defer to the widget's default.
              ...
              height: MediaQuery.of(context).size.height / 28,
                ...
                child: TextButton(
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) => Transaction_History_Type4(UserAdress: widget.UserAdress)
));
                  //   filter1=false;
                  //  filter2=false;
                  //  filter3=false;
      ...
      // ),
        ...
        errorWidget: (context, url, error) => Icon(Icons.error),
            ...
            onPressed: (){
              print(Address);
              FlutterClipboard.copy(sea.details["TransactionHash"])
