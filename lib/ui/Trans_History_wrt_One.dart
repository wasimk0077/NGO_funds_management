...
class Transaction_History_Wrt_One extends StatefulWidget {
  Transaction_History_Wrt_One({super.key,required this.NGOAddress });
  // final String Link;
   final String NGOAddress;
  @override
  State<Transaction_History_Wrt_One> createState() => Transaction_History_Wrt_OneState();
}

class Transaction_History_Wrt_OneState extends State<Transaction_History_Wrt_One> {
...
getData() async {
  ...
  await FirebaseFirestore.instance.collection("Transactions").get().then((value) {
    for(var i in value.docs) {
      ...
      if(widget.NGOAddress==i["NGO_Transactions"]["NGO_Address"]){
      ...
      // ),
        ...
        .then((value) => print('copied'));
                                  ...
                                  //             ),
                                        ...
                                        Container(
                                          child:Text(
                                    sea.details["TransactionValue"]+" ETH",
                                    style: TextStyle(
                                      fontWeight: FontWeight.bold,
                                      fontFamily: "Poppins Medium",
                                      color: Colors.black,
