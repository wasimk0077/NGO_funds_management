...
class Transaction_History_Type2 extends StatefulWidget {
  Transaction_History_Type2({super.key,required this.UserAdress });
  final String UserAdress;

  @override
  State<Transaction_History_Type2> createState() => Transaction_History_Type2State();
}

class Transaction_History_Type2State extends State<Transaction_History_Type2> {
...
getData() async {
  ...
  Widget build(BuildContext context) {
   ...
   return (to.difference(from).inHours / 24).round();
                  ...
                  return  Container(
                    child:sea.details["NGOType"]=="City-based"?Container(
