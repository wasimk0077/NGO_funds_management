              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Row(
                      children: <Widget>[
                        Image.asset("assets/4_cropped.png",height: 28,),
                        SizedBox(width: 8,),
                        Row(
                          children: <Widget>[
                            ...
                            Text(" around us", style: TextStyle(
                        ...
                        Spacer(),
                        Image.asset("assets/4_cropped.png", height: 22,),
                        SizedBox(width: 16,),
                        Image.asset("assets/4_cropped.png", height: 22,)
                      ],
                    ),
                    ...
                    Row(
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: ClipRRect(
                              borderRadius: BorderRadius.circular(30),
                              child: Image.asset("assets/4_cropped.png", height: 40,)),
                        )
                      ],
                    ),
                    SizedBox(height: 20,),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: <Widget>[
          Image.asset("assets/4_cropped.png", height: 27,),
          SizedBox(height: 12,),
      ...
      child: Row(
        children: <Widget>[
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Row(
                    children: <Widget>[
                      Image.asset("assets/4_cropped.png", height: 12,),
                      SizedBox(width: 8,),
                      Text(date, style: TextStyle(
                          color: Colors.white,
                          fontSize: 10
          ...
          ClipRRect(
              ...
              child: Image.asset("assets/4_cropped.png", height: 100,width: 120, fit: BoxFit.cover,)),
        ],
      ),
    );
  }
