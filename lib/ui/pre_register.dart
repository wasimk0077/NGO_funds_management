...
import 'package:beta_app/ui/Register.dart';
import 'package:beta_app/ui/RegisterUser.dart';
...
// import 'package:veots_mobile_app/screens/register_with_phone.dart';
// import 'package:flutter/material.dart';
            ...
            Container(
              ...
              child: Card(
                ...
                child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            if(MediaQuery.of(context).size.width<440)...[
                              CustomCheckBox(
                             checkedIconColor: Colors.blue.shade900,
                              value: IsPhone,
                              shouldShowBorder: true,
                              borderColor: Colors.blue.shade900,
                              checkedFillColor: Colors.blue.shade900,
                            ...
                            else if(MediaQuery.of(context).size.width<692)...[
                               CustomCheckBox(
                              checkedIconColor: Colors.blue.shade900,
                              value: IsPhone,
                              shouldShowBorder: true,
                        ...
                        child: Row(
                          ...
                          children: [
                           if(MediaQuery.of(context).size.width<440)...[
                              ...
                              checkedFillColor: Colors.blue.shade900,
                              // uncheckedFillColor: Colors.white,
                              // uncheckedIconColor: Colors.white3
                              borderRadius: 12,
                              borderWidth: 3,
                              checkBoxSize:
                                  MediaQuery.of(context).size.width / 20,
                  ...
                  //          margin:EdgeInsets.only(bottom: MediaQuery.of(context).size.width*.003,
                  ...
                  //         color: const Color(0xFFdfdfdf),fontWeight: FontWeight.w500,fontSize: MediaQuery.of(context).size.width/25),
                  //   ),
                  // ),
                  //         ),
                  //           ]
                  ...
                  //     labelText: "Other",
                  //     labelStyle: TextStyle(
                  //         color: const Color(0xFFdfdfdf),fontWeight: FontWeight.w500,fontSize: MediaQuery.of(context).size.width/35),
                  //   ),
                  // ),
                  //         ),
                  Container(
          ...
          // );
                               ...
                               FittedBox(
                                ...
                                child: Text(
                                  ...
                                  style: TextStyle(color: const Color(0xFF1a0bbe),
                                  fontFamily: "Poppins Medium"),
                                ),
                              ),
