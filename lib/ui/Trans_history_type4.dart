...
class Transaction_History_Type4 extends StatefulWidget {
  Transaction_History_Type4({super.key,required this.UserAdress });
  final String UserAdress;

  @override
  State<Transaction_History_Type4> createState() => Transaction_History_Type4State();
}

class Transaction_History_Type4State extends State<Transaction_History_Type4> {
...
getData() async {
  ...
  Widget build(BuildContext context) {
   ...
   return (to.difference(from).inHours / 24).round();
                  ...
                  return  Container(
                    child:sea.details["NGOType"]=="National"?Container(
