...
class Transaction_History_Type1 extends StatefulWidget {
  Transaction_History_Type1({super.key,required this.UserAdress });
  final String UserAdress;

  @override
  State<Transaction_History_Type1> createState() => Transaction_History_Type1State();
}

class Transaction_History_Type1State extends State<Transaction_History_Type1> {
...
getData() async {
  ...
  Widget build(BuildContext context) {
   ...
   return (to.difference(from).inHours / 24).round();
                  ...
                  return  Container(
                    child:sea.details["NGOType"]=="International"?Container(
