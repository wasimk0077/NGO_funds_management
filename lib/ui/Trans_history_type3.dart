...
class Transaction_History_Type3 extends StatefulWidget {
  Transaction_History_Type3({super.key,required this.UserAdress });
  final String UserAdress;

  @override
  State<Transaction_History_Type3> createState() => Transaction_History_Type3State();
}

class Transaction_History_Type3State extends State<Transaction_History_Type3> {
  ...
  await FirebaseFirestore.instance.collection("Transactions").get().then((value) {
    for(var i in value.docs) {
     ...
     if(widget.UserAdress==i["NGO_Transactions"]["User_Address"])
     {
      ...
      temp_class.details["NGOType"]=i["NGO_Transactions"]["NGO_Type"];
   ...
   return (to.difference(from).inHours / 24).round();
                    ...
                    Timestamp temp =
                               ...
                               final difference = daysBetween(purchasedDate,currentDate);
                                print("diff");
                               print(difference);
                               if(sea.details["NGOType"]=="International"){
                                print(true);
                               }
                  ...
                  return  Container(
                    child:sea.details["NGOType"]=="Community-based"?Container(
